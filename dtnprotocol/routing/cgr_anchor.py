"""CGR routing algorithm implementation with route anchoring mechanism.
...
CGR Forward Routine:
    This routine has to be executed on a per-bundle basis. :func:`cgr` and
    :func:`identify_proximate_node_list` are part of this routine.
CGR Routing Routine:
...
from dtnprotocol import ContactIdentifier
